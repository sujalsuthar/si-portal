    ...
    <div>
      ...
      <div className="space-y-6">
        ...
        <Section title="3. Performance Overview">
          ...
          <div className="mt-5">
            <h3 className="mb-2 text-xs font-semibold uppercase tracking-wide text-ink-muted">Marks History (All Exams)</h3>
        ...
        <Section title="4. Academic Timeline">
          {loadingTimeline ? (
            <Spinner />
          ) : (
            <div className="card divide-y divide-edge">
              {(timeline?.timeline ?? []).length === 0 && <p className="px-4 py-6 text-center text-sm text-ink-muted">No activity recorded yet</p>}
